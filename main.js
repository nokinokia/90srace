...
var mainState = {
  ...
  create: function () {
    ...
    this.bgSprite = game.add.tileSprite(0, 0, 200, screenHeight, "bg");
    ...
    var txtStyle = { font: '15px "Press Start 2P"', fill: "#333333" };
    var dgtStyle = { font: '20px "Press Start 2P"', fill: "#333333" };
  ...
  update: function () {
    if (this.cursor.right.isDown) this.player.body.x = 100;
    else if (this.cursor.left.isDown) this.player.body.x = 40;
...
var game = new Phaser.Game(300, screenHeight, Phaser.CANVAS);
